...
$matrix = [ordered]@{
  "26.1" = @{ mc="26.1.2";          api="0.152.1+26.1.2"; loader="0.18.6"; lo="26.1-"; hi="26.2"; pf="84"; modver="1.2.9" }
  "26.2" = @{ mc="26.2";            api="0.152.1+26.2";   loader="0.19.3"; lo="26.2-"; hi="26.3"; pf="88"; modver="1.2.9" }
  "26.3" = @{ mc="26.3-snapshot-7"; api="0.156.2+26.3";   loader="0.19.3"; lo="26.3-alpha.7"; hi="26.3-alpha.8"; pf="95"; modver="1.2.9" }
}
