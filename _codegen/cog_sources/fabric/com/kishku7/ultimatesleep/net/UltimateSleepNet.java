...
public final class UltimateSleepNet {
    ...
    public static void registerTypes() {
        ...
        //c2s = compat.fab_c2s(ver); s2c = compat.fab_s2c(ver)
        //regs = [("UsleepRequestPayload","c"),("UsleepSetPayload","c"),("UsleepRosterPayload","c"),
        //        ("UsleepSyncPayload","s"),("UsleepOpenPayload","s"),("UsleepVotePayload","c"),
        //        ("UsleepVoteStartPayload","s"),("UsleepVoteEndPayload","s"),("UsleepVoteInfoPayload","s")]
        //for name, d in regs:
        //    f = c2s if d == "c" else s2c
        //    cog.outl("        PayloadTypeRegistry.%s().register(%s.TYPE, %s.CODEC);" % (f, name, name))
        //]]]
