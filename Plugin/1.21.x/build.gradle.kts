// Ultimate Sleep plugin cell -- MC 1.21.x (Paper / Spigot / Folia). STANDALONE build, mirroring
...
// ultimate-sleep-<ver>+1.21.x-plugin.jar. api-version 1.21, Java 21.
plugins {
    id("java-library")
}
...
tasks {
    ...
    jar {
        archiveFileName.set("ultimate-sleep-${project.version}+1.21.x-plugin.jar")
        manifest {
