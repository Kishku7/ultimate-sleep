...
## Build status (2026-06-20) -- v0.12.0
...
PENDING (client phase only): highlight_blocking_mobs (client glow), client admin GUI + vote popup; (also: sleep_anytime+ACCELERATE composition, perf tuning). Prior:
